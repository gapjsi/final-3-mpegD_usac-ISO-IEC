...
/* table of successive powers of 2 (for the computation of the sign code of
   a signed leader */
extern"C" {
    extern const int tab_pow2[8] = { 128, 64, 32, 16, 8, 4, 2, 1 };

    /* table of factorial */
    extern const int tab_factorial[8] = { 5040, 720, 120, 24, 6, 2, 1, 1 };

    /* Da_pos - Position of the first absolute leader on a spherical shell (or sphere) */
    extern const int Da_pos[NB_SPHERE] = {
    ...
    extern const unsigned int Da_id[NB_LEADER] = {
    ...
    /*  Da - Absolute leaders */
    extern const unsigned char Da[NB_LEADER][8] = {
      { 1,  1,  1,  1,  1,  1,  1,  1},
      { 2,  2,  0,  0,  0,  0,  0,  0},
      { 2,  2,  2,  2,  0,  0,  0,  0},
      { 3,  1,  1,  1,  1,  1,  1,  1},
